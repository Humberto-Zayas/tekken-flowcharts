  ...
  <div>
    ...
    <b-container class="bv-example-row">
      ...
      <div>
        ...
        <b-card-body>
          <b-card-title>View Akuma Frame Data and Move Properties</b-card-title>
          <b-button to="akuma/frame-data" variant="primary">Akuma Frame Data</b-button>
        </b-card-body>
        </b-card>
      </div>
